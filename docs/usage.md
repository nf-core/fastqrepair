# nf-core/fastqrepair: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/fastqrepair/usage](https://nf-co.re/fastqrepair/usage)
...
> [!WARNING]
> Different file extensions are not allowed _in the same row_, i.e., in the same paired-end sample (e.g., `mysampleA,sample_R1.fastq.gz,sample_R2.fastq`)
...
```bash
nextflow run nf-core/fastqrepair -profile docker -params-file params.yaml
```
...
```bash
nextflow pull nf-core/fastqrepair
```
